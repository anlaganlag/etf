...
# --- Conservative Config: T=12 + Tight Stop ---
TOP_N = 5
STOP_LOSS = 0.12  # 紧止损
TRAILING_TRIGGER = 0.05
TRAILING_DROP = 0.05
MIN_SCORE = 20
REBALANCE_PERIOD_T = 12  # 更慢换手
STATE_FILE = "rolling_state_conservative.json"
...
def get_ranking(context, current_dt):
    ...
    periods_rule = {1: 30, 3: 40, 5: 50, 10: 60, 20: 70}  # 平衡权重
...
def on_backtest_finished(context, indicator):
    print(f"\n=== CONSERVATIVE (T={REBALANCE_PERIOD_T}) RESULTS ===")
...
if __name__ == '__main__':
    run(strategy_id='conservative_rolling', filename='gm_strategy_conservative.py', mode=MODE_BACKTEST,
