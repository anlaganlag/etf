...
def run_t14_neighborhood_scan():
    print("=== T14 Neighborhood Scan (T=11-17) | Nov 2025 - Jan 2026 ===")
    config.ensure_dirs()
    ...
    t_range = range(11, 18) # T=11 to T=17
    min_score = 150
    
    print(f"\nSim Period: {start_sim} to Present")
