...
| 策略表现 | **T14 (最优)** | T20 (稳健) | 沪深300基准 | 中证500基准 |
|----------|----------------|------------|-------------|-------------|
| **累计收益率** | **+38.81%** | +36.95% | +17.60% | +43.82% |
| **年化收益率** | **+38.81%** | +36.95% | +13.85% | +33.74% |
| **最大回撤** | -21.35% | **-20.06%** | -13.02% | -17.91% |
| **夏普比率** | **1.04** | 1.03 | 0.85 | 1.59 |
| **交易次数** | 5,654 | 5,599 | - | - |
| **超额收益(vs沪深300)** | **+24.96%** | +23.10% | - | - |
| **超额收益(vs中证500)** | **+5.08%** | +3.21% | - | - |

> 💡 **关键发现**: 
> - **T14是收益最优解**：年化38.81%，超越沪深300基准2.80倍
> - **T20是风险最优解**：回撤仅-20.06%，收益仍达36.95%
> - **T1-T4表现较差**：持仓时间过短导致交易成本过高
> - **T7-T20是黄金区间**：收益30%+，回撤20-25%
